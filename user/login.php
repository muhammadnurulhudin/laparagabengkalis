...
<div class="wrapper">
        ...
        <div class="text-center mt-4 name">
            <?php echo isset($_SESSION["username"]) ? 'Welcome, ' . $_SESSION["username"] : ''; ?>
        </div>
        <form class="p-3 mt-3" id="loginForm" method="post" action="action/ceklogin.php">
...
<script>
    function performLogin() {
        ...
        if (userNameInput === '' || passwordInput === '') {
            ...
            // Ganti window.location.href dengan alamat menuju home.html
