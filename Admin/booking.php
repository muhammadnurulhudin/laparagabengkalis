        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="frmEditDataBooking" id="frmEditDataBooking" method="POST" action="action/editdatabooking.php?id=<?php echo $rowBooking['Id_booking']; ?>" enctype="multipart/form-data">
                    ...
                    <br>
                    <label style="display:block; text-align:left;">metode_pembayaran</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="frmEditDataBooking" id="frmEditDataBooking" method="POST" action="action/editdatabooking.php?id=<?php echo $rowBooking['Id_booking']; ?>" enctype="multipart/form-data">
                    ...
                    <br>
                    <label style="display:block; text-align:left;">metode_pembayaran</label>
                    <select type="text" name="txtEditMetode_pembayaran" id="txtEditMetode_pembayaran" class="form-control" value="<?php echo $rowBooking['metode_bayar']; ?>" >
                    <option value="pilih">- Pilih -</option>
                    <option>transer bank</option>
                    <option>cash</option>
                  </select>
    ...
    <div id="modalTambahDatabooking" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form name="frmTmbhDataBooking" id="frmTmbhDataBooking" method="POST" action="action/SimpanDataBooking.php?id=<?php echo $rowBooking['Id_booking']; ?>" enctype="multipart/form-data">
                    <label style="display:block; text-align:left;">ID BOOKING</label>
                    <input type="text" name="txtId_booking" id="txtId_booking" class="form-control" value="<?php echo isset($rowBooking['Id_booking']) ? $rowBooking['Id_booking'] : ''; ?>" />
                    <br>
                    <label style="display:block; text-align:left;">TANGGAL BOOKING</label>
                    <input type="date" name="txtTgl_booking" id="txtTgl_booking" class="form-control" value="<?php echo $rowBooking['Tgl_booking']; ?>" />
                    <br/>
                    <label style="display:block; text-align:left;">JAM MAIN</label>
                    <input type="text" name="txtJam_main" id="txtJam_main" class="form-control" value="<?php echo isset($rowBooking['Jam_main']) ? $rowBooking['Jam_main'] : ''; ?>" />
                    <br>
                    <label style="display:block; text-align:left;">durasi</label>
                    <input type="text" name="txtdurasi" id="txtdurasi" class="form-control" value="<?php echo isset($rowBooking['durasi']) ? $rowBooking['durasi'] : ''; ?>" />
                    <br/>
                    <label style="display:block; text-align:left;">ID LAPANGAN</label>
                    <select type="text" name="txtId_lapangan" id="txtId_lapangan" class="form-control" value="<?php echo $rowBooking['Id_lapangan']; ?>" >
                    <option> </option>
                    <option>lapangan 1</option>
                    <option>lapangan 2</option>
                  </select>
                    <br>
                    <label style="display:block; text-align:left;">metode_pembayaran</label>
                    <select type="text" name="txtmetode_bayar" id="txtmetode_bayar" class="form-control" value="<?php echo $rowBooking['metode_bayar']; ?>" >
                    ...
                    <br>
                    <label style="display:block; text-align:left;">bukti</label>
                    <input type="text" name="txtbukti" id="txtbukti" class="form-control" value="<?php echo isset($rowBooking['bukti_bayar']) ? $rowBooking['bukti_bayar'] : ''; ?>" />
                    <br>
                    <label style="display:block; text-align:left;">status</label>
                    <select type="text" name="txtstatus" id="txtstatus" class="form-control" value="<?php echo $rowBooking['status']; ?>">
                    <option> </option>
                    <option>Ready</option>
                    <option>sedang diproses</option>
                    <option>Dipakai</option>
